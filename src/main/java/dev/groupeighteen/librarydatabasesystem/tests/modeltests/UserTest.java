...
public class UserTest {
    ...
    public void testCreateUser() {
        ...
        System.out.println("Student userID: " + studentObj.getUserID());
        System.out.println("Student username: " + studentObj.getUserName());
        ...
        System.out.println("Student Number of Currently Rented Items: " + studentObj.getItemsRented() + "\n");
        ...
        System.out.println("Teacher Number of Currently Rented Items: " + teacherObj.getItemsRented() + "\n");
        ...
        System.out.println("Researcher Number of Currently Rented Items: " + researcherObj.getItemsRented() + "\n");

        System.out.println("Attempting to change Currently Rented Items to 3...");
        studentObj.setItemsRented(3);
        System.out.println("Number of Currently Rented Items: " + studentObj.getItemsRented());
